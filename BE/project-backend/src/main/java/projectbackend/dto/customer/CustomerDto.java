...
public class CustomerDto implements Validator {
    ...
    public CustomerDto(Integer id, String name, boolean isDelete, String dayOfBirth, Integer gender, String idCard, String email, String address, String phoneNumber, PhoneCustomer phoneCustomer, Account account) {
        this.id = id;
        this.name = name;
    ...
    public PhoneCustomer getPhoneCustomer() {
        return phoneCustomer;
    }

    public void setPhoneCustomer(PhoneCustomer phoneCustomer) {
        this.phoneCustomer = phoneCustomer;
    }
